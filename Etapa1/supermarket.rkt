...
(define (min-tt counters)
  (match (min-tt-help (cdr counters) (car counters)) [(counter index tt _) (cons index tt)]))

(define (min-tt-help counters min)
  (cond
    ((null? counters) min)
    ((< (counter-tt (car counters)) (counter-tt min)) (min-tt-help (cdr counters) (car counters)))
    ((= (counter-tt (car counters)) (counter-tt min)) (if (< (counter-index (car counters)) (counter-index min))
                                                          (min-tt-help (cdr counters) (car counters))
                                                          (min-tt-help (cdr counters) min)))
    (else (min-tt-help (cdr counters) min))))
